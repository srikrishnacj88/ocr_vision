package in.sskrishna.ocr.impl.abbyy.sdk;
...
public class Client {
    ...
    public String serverUrl = "http://cloud.sdk.com";
    ...
    public void downloadResult(Task task, StringWriter writer) throws Exception {
    ...
    private Task getResponse(HttpURLConnection connection) throws Exception {
        ...
        if (responseCode == 200) {
            ...
            try {
                ...
                String text = IOUtils.toString(errorStream, StandardCharsets.UTF_8.name());
